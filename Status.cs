...
namespace AddressClick.Core.Responses
{
    public readonly struct Status : IEquatable<Status>
    {
        ...
        public static readonly Status Success = new Status(SuccessKey);

        public static readonly Status BadRequest = new Status(BadRequestKey);

        public static readonly Status NotFound = new Status(NotFoundKey);

        public static readonly Status Unauthorized = new Status(UnauthorizedKey);
